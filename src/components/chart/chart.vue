  ...
  <div class="chart-container">
    ...
    <el-dropdown placement="bottom-start" trigger="click" ref="menuBox"
      ...
      <el-dropdown-menu slot="dropdown" :divided="true" class="graph-menu-item">
        ...
        <el-dropdown-item v-if="currentClickNode" command="up">添加上游</el-dropdown-item>
        <el-dropdown-item v-if="currentClickNode" command="down">展开下游</el-dropdown-item>
        <el-dropdown-item v-if="currentClickNode" command="down">添加下游</el-dropdown-item>
  ...
  export default {
    ...
    methods: {
      ...
      initData(data) {
        let totalList = [];
        let repeatList = [];
        this.chartData = judgeList(data, null);
